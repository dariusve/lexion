...
- Harden ProseMirror rendering defaults by enforcing required root editor white-space styles in `LexionEditorView`, preventing the common `prosemirror.css` console warning from appearing in React integrations.
