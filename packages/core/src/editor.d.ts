...
import type { CommandHandler, JSONDocument, LexionEditor as LexionEditorContract, LexionEditorOptions, LexionExtension, LexionStatusBarItem } from "./types.js";
export declare class LexionEditor implements LexionEditorContract {
    ...
    private createStatusBarContext;
